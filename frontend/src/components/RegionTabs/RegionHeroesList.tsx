...
const RegionHeroesList: React.FC<RegionHeroesListProps> = ({ heroes, loading, onSelectHero }) => {
  if (loading) {
    return <div className="text-center py-8 text-gray-400">Loading heroes...</div>;
  }
  ...
  if (livingHeroes.length === 0) {
    return (
      <div className="text-center py-8 text-gray-400">No living heroes found in this region</div>
    );
  }
