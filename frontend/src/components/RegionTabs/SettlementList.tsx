...
const SettlementItem: React.FC<SettlementItemProps> = ({ settlement, onSelectSettlement }) => {  // Using the imported getSettlementIcon function from regionUtils
    ...
    >
      <div className="flex items-center space-x-2">
        <span className="text-sm">
          {getSettlementIcon(settlement.type)}
        </span>
