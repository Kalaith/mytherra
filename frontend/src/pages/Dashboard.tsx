        ...
        <PageLayout gameStatus={gameStatus}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                <div className="bg-[#1a1b26] p-4 rounded-lg border border-[#2f334d]">
                    ...
                    <div className="text-2xl font-bold text-blue-400">{summary?.currentEra} (Year {summary?.currentYear})</div>
                </div>
                <div className="bg-[#1a1b26] p-4 rounded-lg border border-[#2f334d]">
                ...
                <div className="bg-[#1a1b26] p-4 rounded-lg border border-[#2f334d]">
                    ...
                    <div className="text-2xl font-bold text-yellow-400">{regionStats?.totalPopulation.toLocaleString()}</div>
                </div>
                <div className="bg-[#1a1b26] p-4 rounded-lg border border-[#2f334d]">
            ...
            <div className="mt-8 bg-[#1a1b26] p-6 rounded-lg border border-[#2f334d]">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <div className="text-xl font-bold text-yellow-500">{financialStats?.totalInfluenceWagered}</div>
                    </div>
                    <div>
